...
const UserTeams = () => {
 ...
 { id: 5, name: 'Alice Williams', role: 'Mine Manager', email: 'alice.williams@company.com', phone: '321-987-6543', status: true, lastLogin: '2024-03-12' },
  ...
  const [teams, setTeams] = useState([
    { id: 1, name: 'Mine Manager 1', description: 'Primary mining operations', members: 10, shiftIncharges: 2, users: [] },
    { id: 2, name: 'Mine Manager 2', description: 'Secondary mining zone', members: 12, shiftIncharges: 3, users: [] },
    { id: 3, name: 'Security Team', description: 'Site protection unit', members: 6, shiftIncharges: 1, users: [] },
    { id: 4, name: 'HR Team', description: 'Human resources dept', members: 4, shiftIncharges: 1, users: [] },
  ]);
  ...
  const handleAddTeam = () => {
    ...
    const newTeamWithId = {
      id: teams.length + 1,
      name: newTeam.name,
      description: newTeam.description, // Added description
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block mb-2">
              Authority Level: {newRole.authorityLevel}%
            </label>
            <input
              type="range"
              min="0"
              ...
              onChange={(e) =>
                setNewRole({
                  ...newRole,
                  authorityLevel: parseInt(e.target.value),
                })
              }
              className="w-full"
            />
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            <input
              ...
              onChange={(e) =>
                setEditingUser({ ...editingUser, status: e.target.checked })
              }
              className="mr-2"
            />
            <span>Active</span>
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-r from-gray-900 to-black-800  text-white">
      ...
      <div className="absolute top-20 right-32 w-40 h-40 rounded-full bg-green-700/50 opacity-81 blur-3xl"></div>
      ...
      <div className=" bg-gradient-to-r from-gray-900/80 to-black-800  p-6 flex justify-between items-center border-b border-gray-800 ">
        ...
        <div
          className="bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded-md flex items-center gap-2 cursor-pointer mr-5"
                ...
                {filteredData().map((user) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center ${getRoleStyles(
                            user.role
                          )}`}
                        >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-sm ${getRoleStyles(
                          user.role
                        )}`}
                      >
                        {user.role}
                    ...
                    <td className="px-6 py-4">
                      <div
                        className={`px-3 py-1 rounded-full text-sm inline-flex ${
                          user.status
                ...
                {filteredData().map((team) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 relative">
                      <div className="group">
                        <span className="inline-block max-w-[200px] overflow-hidden whitespace-nowrap text-ellipsis">
                          {team.description.length > 15
                            ? `${team.description.slice(0, 15)}...`
                            : team.description}
                        </span>
                        {team.description.length > 15 && (
                          <span
                            className="absolute z-10 bg-gray-700 text-white p-2 rounded shadow-lg 
                          opacity-0 group-hover:opacity-100 transition-opacity duration-300 
                          pointer-events-none left-0 top-full mt-2"
                          >
                            {team.description}
                          </span>
                        )}
